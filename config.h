...
/* appearance */
static const char font[] = "Ricty:size=10";
...
static const Tag tags[] = {
	...
	{ "一 home",   &layouts[0], -1,	-1 },
	{ "二 term",   &layouts[0], -1,	-1 },
	{ "三 code",   &layouts[0], -1,	-1 },
	{ "四 web",    &layouts[1], -1,	-1 },
	{ "五 misc",   &layouts[3], -1,	-1 },
};
...
static const char *pad[]	= { "termite", "--title", scratchpadname, "--geometry", "640x240", NULL };
